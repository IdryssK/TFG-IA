    ...
    registerHandlers(): void
    {
        ...
        this._fuseMockApiService
            ...
            .reply(({request}) =>
            {
                ...
                {
                    // Filter the products
                    products = products.filter(contact => (contact.name && contact.name.toLowerCase().includes(search.toLowerCase())) || (contact.sku && contact.sku.toLowerCase().includes(search.toLowerCase())));
                }
